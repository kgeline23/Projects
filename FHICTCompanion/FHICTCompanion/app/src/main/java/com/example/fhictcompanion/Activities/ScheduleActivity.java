...
public class ScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> weekAdapter = new ArrayAdapter<String>(ScheduleActivity.this,android.R.layout.simple_expandable_list_item_1, getResources().getStringArray(R.array.Week));
        weekAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerW.setAdapter(weekAdapter);

        ArrayAdapter<String> classAdapter = new ArrayAdapter<String>(ScheduleActivity.this,android.R.layout.simple_expandable_list_item_1, getResources().getStringArray(R.array.Classes));

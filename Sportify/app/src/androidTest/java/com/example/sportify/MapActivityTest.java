...
public class MapActivityTest {
    ...
    public void mapActivityTest() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.LogEmail),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("inwide97@aco"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.LogEmail), withText("inwide97@aco"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.LogEmail), withText("inwide97@aco"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("inwide97@gmail.com"));

        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.LogEmail), withText("inwide97@gmail.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.LogPassword), withText("test"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText13 = onView(
                allOf(withId(R.id.LogPassword), withText("test"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText13.perform(replaceText("kiashi100"));

        ViewInteraction appCompatEditText14 = onView(
                allOf(withId(R.id.LogPassword), withText("kiashi100"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
